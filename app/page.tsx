...
const clientId = "BGyZf5eBCFKM-lHrZpi7iwZkhTogZ0kDqaX3thbz0IkRvnnrv8N3wcFnLLJSQOodcWi68EraSaEfiwbMRRqQm-s"; // get from https://dashboard.web3auth.io
...
export default function App() {
  ...
  const switchChain = async () => {
    ...
    await web3auth?.switchChain({ chainId: "0x1f92" });
